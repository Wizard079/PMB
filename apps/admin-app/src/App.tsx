...
function App() {
    ...
    if (currentMatch) {
      if (currentMatch.balls1 < NUM_OVERS * 6 && currentMatch.wickets1 < 10) {
        ...
        if (ball === "W") {
          ...
          if ((currentMatch.wickets2 + 1 === 10) || (currentMatch.balls2+1 === NUM_OVERS * 6)) customStat = "COMPLETED"
          ...
          let customStat = "IN_PROGRESS"
          if ((currentMatch.balls2+1 === NUM_OVERS * 6)) customStat = "COMPLETED"
  ...
  return (
    <>
      <div className="bg-green-950 h-screen flex justify-center gap-20 items-center flex-col">
        ...
        <div className="flex gap-10 items-center">
          <div className="bg-white w-[500px] h-[350px] rounded-lg shadow-lg flex justify-center items-center">
            <div className="text-center flex flex-col gap-10">
              ...
              <CreateMatchComponent setMatches= {setMatches} />
            </div>
          </div>

          <div className="text-center">

            <h1 className="text-[30px] text-white">{matches.length ? <div>Existing Matches</div>: <></>}{!matches.length ? <div>No Existing Matches</div>: <></> }</h1>
...
function CreateMatchComponent({ setMatches }: { setMatches: React.Dispatch<React.SetStateAction<Match[]>> }) {
  ...
  async function createMatchHandler() {
    if (!(team1 === "" || team2 === "")) {
      ...
      console.log(res.data)
      setMatches(matches => [...matches, res.data.match])
      setTeam1("")
      setTeam2("")
    }
  }
